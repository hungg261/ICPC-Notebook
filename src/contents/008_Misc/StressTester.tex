...
Automated stress testing harness using identical execution checking paths. Run \lstinline|main.cpp| to compile and test.

\begin{lstlisting}[caption={checker.cpp}]
int32_t main() {
